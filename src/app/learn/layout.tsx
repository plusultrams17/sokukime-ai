          ...
          "@graph": [
            {
              ...
              offers: [
                ...
                },
                {
                  ...
                  priceCurrency: "JPY",
                  availability: "https://schema.org/InStock",
                  description: "ライトプラン（月額・税込）で全22レッスン＋認定試験・AIロープレ月30回",
                },
                {
                  "@type": "Offer",
                  price: "6980",
                  priceCurrency: "JPY",
                  availability: "https://schema.org/InStock",
                  description: "プロプラン（月額・税込）で全22レッスン＋認定試験・AIロープレ月100回",
                },
                {
                  "@type": "Offer",
                  price: "14800",
                  priceCurrency: "JPY",
                  availability: "https://schema.org/InStock",
                  description: "無制限プラン（月額・税込）で全22レッスン＋認定試験・AIロープレ実質無制限（月300回まで）・優先サポート",
                },
              ],
            },
            {
