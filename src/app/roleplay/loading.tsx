    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="flex flex-col items-center gap-6">
        ...
        >
          ...
          />
          {/* Upper sparkle lines */}
          <path pathLength="360" d="M32 22v-4" />
          <path pathLength="360" d="M26 24l-2-3" />
          <path pathLength="360" d="M38 24l2-3" />
          <path pathLength="360" d="M22 28l-3-1" />
          <path pathLength="360" d="M42 28l3-1" />
          {/* Trust dots */}
          <path pathLength="360" d="M32 17a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
          <path pathLength="360" d="M23 20a0.8 0.8 0 1 0 0-1.6 0.8 0.8 0 0 0 0 1.6z" />
          <path pathLength="360" d="M41 20a0.8 0.8 0 1 0 0-1.6 0.8 0.8 0 0 0 0 1.6z" />
          {/* Lower support */}
          <path pathLength="360" d="M24 44c2 2 5 3 8 3s6-1 8-3" />
          {/* Cuffs */}
          <path pathLength="360" d="M12 35c0-1 1-2 3-2.5" />
          <path pathLength="360" d="M52 35c0-1-1-2-3-2.5" />
        </svg>
