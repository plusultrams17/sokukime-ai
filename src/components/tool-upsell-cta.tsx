  ...
  return (
    <div className="rounded-2xl border-2 border-accent bg-accent/5 p-6 text-center sm:p-8">
      ...
      <p className="mb-4 text-sm text-muted leading-relaxed">
        22レッスンで営業の「型」を体系的に習得。AIロープレ月100回・PDF教材・反論切り返し30パターンすべて使い放題。
      </p>
      <div className="mb-4 flex items-center justify-center gap-2">
        <span className="text-2xl font-bold text-accent">¥6,980</span>
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-accent/30 bg-accent/5 p-6 text-center sm:p-8">
        ...
        <p className="mb-5 text-sm text-muted">
          ...
          プロプランなら月100回まで。¥6,980/月でいつでも解約OK。
        </p>
        ...
        <p className="mt-3 text-xs text-muted">
          &#10003; 登録不要で体験OK &#10003; ライト ¥2,980〜 / プロ ¥6,980 &#10003; いつでも解約可能
        </p>
      </div>
    </div>
  );
