...
const entries: ChangelogEntry[] = [
  {
    date: "2026-07-24",
    version: "3.0.0",
    title: "全面リニューアル（住宅・リフォーム・塗装営業特化＋新料金プラン）",
    changes: [
      "サービスの見せ方を住宅・リフォーム・塗装など現場商談の営業向けに刷新",
      "料金プランを刷新：ライト ¥2,980/月（月30回）・プロ ¥6,980/月（月100回）・無制限 ¥14,800/月（月300回）。プロは年払い ¥69,800/年に対応",
      "法人プランを3ティアに整理（1人あたり月¥1,980〜¥2,980・年払い20%オフ）。導入設定から月次の活用レポートまで運営が伴走",
      "フリープラン（累計5回お試し）は変更なし",
    ],
  },
  {
    date: "2026-04-11",
    version: "2.1.0",
    title: "4プラン構成への刷新（Starter / Pro / Master）",
    changes: [
      "料金プランをFree＋3つの有料プラン構成に刷新：Starter ¥990/月（月30回）・Pro ¥1,980/月（月60回）・Master ¥4,980/月（月200回）",
      "AIロープレの使用量管理を日次から月次クレジット制に変更（毎月1日 0:00 JSTリセット）",
      "既存のProサブスクリプション契約は新Proプラン（月60回）に自動マッピング",
      "14日間返金保証を廃止、Freeプランで5回お試し可能",
    ],
  },
  {
    date: "2026-04-10",
    version: "2.0.0",
    title: "買い切りプログラム販売終了・サブスク統合",
    changes: [
      "買い切りプログラム（¥9,800）を販売終了し、全機能を月額サブスクリプションに統合",
      "全22レッスン・PDF教材・反論切り返し30パターンを有料プラン特典として提供",
      "既存の買い切りプログラム購入者は引き続き全機能にアクセス可能（グランドファザリング）",
      "/program は /pricing へリダイレクト、/program/resources は有料会員特典ページとして存続",
    ],
  },
  {
    date: "2026-03-30",
