...
3. 予算の壁（価格が高い・予算がない）
   ...
   - obj3Rebuttal: あなたの切り返し（驚き→謝罪→価値の上乗せの流れ）
4. タイミングの壁（今じゃなくてもいい）
