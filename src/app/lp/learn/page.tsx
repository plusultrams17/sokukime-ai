...
export const metadata: Metadata = {
  ...
  description:
    "営業心理学から体系化した成約5ステップメソッド。22レッスン・3レベル構成の営業学習プログラム。理論→トーク例→クイズ→実践の4ステップで効果的にスキルアップ。",
  openGraph: {
    title:
      "営業研修を無料でオンライン受講 | 22レッスン+認定試験 | 成約コーチAI",
    description:
...
const faqs = [
  {
    q: "本当に無料で学習できますか？",
    a: "はい。基本3レッスンの理論解説・トーク例・確認クイズは無料でご利用いただけます。Googleログインで今すぐ学習を始められます。全22レッスンは有料プラン（Starter ¥990/月〜）で解放されます。",
  },
  {
  ...
  const jsonLdData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          "営業心理学から体系化した営業メソッド。22レッスン・3レベル構成。理論→トーク例→クイズ→実践の4ステップで効果的にスキルアップ。",
        provider: {
          "@type": "Organization",
          name: "成約コーチAI",
          url: SITE_URL,
