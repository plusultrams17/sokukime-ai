    ...
    items: [
      {
        ...
        answer:
          "成約コーチAIは、営業心理学に基づく5ステップメソッドを使い、AIとのロープレ（模擬商談）を通じて営業スキルを鍛えるオンラインサービスです。24時間いつでもAI相手に練習でき、Proプランでは全5カテゴリの詳細スコアで自分の強み・弱みを可視化できます（無料プランは1カテゴリ・累計5回まで）。",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        question: "返金はできますか？",
        answer:
          "デジタルコンテンツの性質上、ご購入後の返金は原則として承っておりません。Freeプランで累計5回まで無料でAIロープレをお試しいただけるため、ご納得いただいたうえでお申し込みください。なお、解約後も現在の請求期間の終了までProプランをご利用いただけます。",
      },
    ],
  },
  {
