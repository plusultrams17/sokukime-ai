...
- ゴール共有ができているか（事前に合意を取る、心理的安全を確保する）
...
- 各カテゴリのfeedbackには「次回はこうしてみましょう」という具体的アクション提案を1つ含めてください
- improvementsは「〜を練習しましょう」ではなく「次のロープレで〜と言ってみてください」のように即実践できるアドバイスにしてください`;
