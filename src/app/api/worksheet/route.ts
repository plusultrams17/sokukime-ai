...
const PROMPTS: Record<string, string> = {
  // アプローチ
  needs_phrase:
    "この業種・商材のお客さんが抱える一般的なニーズ・お悩み・問題点を12個挙げてください。また、ニーズ発掘フレーズ「___で悩んでいる人が多いですが」の空欄に入る1〜3語のキーワードも提案してください。",

  // ヒアリング
  deepening:
    "この業種・商材の営業において、お客さんの問題を深掘りする「課題深掘りシート」用の質問を5個生成してください。以下の5カテゴリに対応した質問を、この業界に特有の表現で作成してください：①原因（何が原因か）、②いつから（時間軸）、③具体的に（状況・痛みの視覚化）、④問題認識（感情的な気づき）、⑤なぜ（解決しなかった理由）。また、ニーズ発掘フレーズの空欄キーワードも提案してください。",
...
以下のJSON形式で回答してください:
{
  ${needsPhrase ? '"phraseKeyword": "（ニーズ発掘フレーズの空欄に入るキーワード）",' : ""}
