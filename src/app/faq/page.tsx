    ...
    items: [
      {
        ...
        answer:
          "無料プランはAIロープレを累計5回まで（生涯の上限）お試しいただけ、スコアは1カテゴリのみ詳細表示されます。有料プランでは全5カテゴリの詳細スコアとAI改善アドバイスが使え、Starter月30回 / Pro月60回 / Master月200回のロープレが使えます。",
      },
      {
        question: "有料プランの料金はいくらですか？",
        answer:
          "Starter ¥990 / Pro ¥1,980 / Master ¥4,980（すべて月額・税込）の3プランがあります。いつでも解約できます。Freeプランで累計5回まで無料でAIロープレをお試しいただけるため、ご納得いただいたうえでお申し込みください。",
      },
      {
        question: "無料で試せますか？",
        answer:
      ...
      },
      {
        ...
        answer:
          "現在は月額プランのみご提供しています（Starter ¥990/月、Pro ¥1,980/月、Master ¥4,980/月）。いつでも解約できます。",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "あなたの紹介リンクからお友達がProプラン（¥1,980/月）以上に登録すると、あなたもお友達も次回のお支払いから¥1,000 OFFになるプログラムです。割引は1名の紹介につき1回適用されます。",
      },
      {
