...
## 4プラン構成 (Source of Truth・2026-07-24全面リニューアル)
| プラン(tierキー) | 表示名 | 月額 | ロープレ | スコア | レッスン |
|--------|------|------|----------|--------|----------|
| free | フリー | ¥0 | 累計5回(生涯) | 1カテゴリ | 基本3レッスン |
| starter | ライト | ¥2,980 | 月30回 | 全5カテゴリ | 全22レッスン |
| pro | プロ | ¥6,980 (年払い¥69,800) | 月100回 | 全5カテゴリ | 全22レッスン |
| master | 無制限 | ¥14,800 | 月300回(実質無制限と表記) | 全5カテゴリ | 全22レッスン |

法人(TEAM_PLANS・3ティア): Team 5-9名 ¥2,980/人・Business 10-29名 ¥2,480/人・Enterprise 30名〜 ¥1,980/人。年払い20%オフ。Enterprise+(team_50)は2026-07-24廃止。

- `isPaid`: `plan === "starter" || plan === "pro" || plan === "master"`
- ポジショニング: 住宅・リフォーム・塗装など現場商談の営業向けに特化した見せ方（製品は汎用）
- 7日間無料トライアルは廃止済み
- 買い切りプログラムは販売終了済み
- キャンペーンは全停止中（インフラは残存）
