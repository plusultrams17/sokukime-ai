  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "月額¥2,980（税込）です。7日間の無料トライアル付きで、トライアル中にキャンセルすれば一切課金されません。",
      },
      {
        question: "7日間の無料トライアルとは？",
        answer:
          "Proプランに申し込むと、最初の7日間は無料でAIロープレ（1日5回）・基本3レッスンをお試しいただけます。トライアル期間中にいつでもキャンセル可能で、キャンセルすれば一切課金されません。トライアル終了後に課金が開始され、全22レッスン・無制限ロープレなどPro全機能が解放されます。",
      },
      {
        question: "支払い方法は？",
        answer:
      ...
      },
      {
        ...
        answer:
          "はい、いつでも解約できます。解約後も現在の請求期間の終了までProプランをご利用いただけます。14日間返金保証もあります。解約手続きはアプリ内の設定ページからワンクリックで行えます。",
      },
      {
        question: "年額プランはありますか？",
        answer:
          "現在は月額プラン（¥2,980/月）のみご提供しています。いつでも解約でき、14日間の返金保証もあります。",
      },
      {
