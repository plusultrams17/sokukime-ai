...
const benefits = [
  {
    ...
    title: "研修コスト1/10以下",
    description:
      "集合型営業研修（1回5万円〜）と比べ、成約コーチAIなら1人月額1,980円〜。年間で数百万円のコスト削減が可能です。",
  },
  {
    icon: "",
    title: "成果を数値で可視化",
...
const ringiTemplate = `【稟議書】AIロープレツール「成約コーチAI」導入について

■ 件名
営業チーム向けAIロープレツール「成約コーチAI」チームプラン導入
...
■ 導入ツール概要
サービス名: 成約コーチAI（https://seiyaku-coach.vercel.app）
提供形態: SaaS（クラウド）
