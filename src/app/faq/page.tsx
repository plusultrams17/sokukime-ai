    ...
    items: [
      {
        ...
        answer:
          "成約コーチAIは、営業心理学に基づく5ステップメソッドを使い、AIとのロープレ（模擬商談）を通じて営業スキルを鍛えるオンラインサービスです。24時間いつでもAI相手に練習でき、プロプランでは全5カテゴリの詳細スコアで自分の強み・弱みを可視化できます（無料プランは1カテゴリ・累計5回まで）。",
      },
      {
        question: "どのようなシーンで練習できますか？",
        answer:
          "新規開拓・既存顧客フォロー・クレーム対応など、複数の営業シーンを選択できます。また、難易度（初級・中級・上級）や業界（不動産・保険・SaaS・人材・教育・物販など）を指定して、実際の商談に近い環境で練習できます。",
      },
      {
        question: "スコアはどのように算出されますか？",
        answer:
          "AIが営業心理学の5カテゴリ（アプローチ・ヒアリング・プレゼン・クロージング・反論処理）で会話内容を分析し、各カテゴリ0〜20点（合計100点満点）で採点します。総合スコアはS〜Dの5段階ランクで表示されます。無料プランでは1カテゴリのみ、プロプランで全5カテゴリの詳細が確認できます。",
      },
      {
    ...
    items: [
      {
        ...
        answer:
          "無料プランはAIロープレを累計5回まで（生涯の上限）お試しいただけ、スコアは1カテゴリのみ詳細表示されます。有料プランでは全5カテゴリの詳細スコアとAI改善アドバイスが使え、ライト月30回 / プロ月100回 / 無制限月300回のロープレが使えます。",
      },
      {
        question: "有料プランの料金はいくらですか？",
        answer:
          "ライト ¥2,980 / プロ ¥6,980 / 無制限 ¥14,800（すべて月額・税込）の3プランがあります。法人向けチームプランは1人¥2,980からご用意しています。いつでも解約できます。Freeプランで累計5回まで無料でAIロープレをお試しいただけるため、ご納得いただいたうえでお申し込みください。",
      },
      {
        question: "無料で試せますか？",
        answer:
          "はい。Googleアカウントでログインすると、AIロープレを累計5回まで無料で体験できます（1日に何回使っても生涯合計5回までの上限）。クレジットカード不要で、いつでもProにアップグレードできます。",
      },
      {
        question: "支払い方法は？",
        answer:
      ...
      },
      {
        ...
        answer:
          "はい、いつでも解約できます。解約後も現在の請求期間の終了日までご利用いただけます。解約手続きはアプリ内の設定ページから数ステップで行えます（引き止めのための入力などはありません）。",
      },
      {
        question: "年額プランはありますか？",
        answer:
          "現在は月額プランのみご提供しています（ライト ¥2,980/月、プロ ¥6,980/月、無制限 ¥14,800/月）。いつでも解約できます。",
      },
      {
      ...
      },
      {
        question: "返金はできますか？",
        answer:
          "デジタルコンテンツの性質上、ご購入後の返金は原則として承っておりません。Freeプランで累計5回まで無料でAIロープレをお試しいただけるため、ご納得いただいたうえでお申し込みください。なお、解約後も現在の請求期間の終了までプロプランをご利用いただけます。",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "あなたの紹介リンクからお友達がプロプラン（¥6,980/月）以上に登録すると、あなたもお友達も次回のお支払いから¥1,000 OFFになるプログラムです。割引は1名の紹介につき1回適用されます。",
      },
      {
